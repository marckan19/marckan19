...
if((isset($_SESSION['user_id']) && $_SESSION['user_type'] == 'a') || (isset($_COOKIE['ciastko_zalogowany']) && $_COOKIE['ciastko_zalogowany'] == 'a')){
	...
	if(isset($_POST['usun'])){
		...
		$query_update = "UPDATE panel_tabela_wyjazdy_budowy SET is_deleted = 1 WHERE id = ".$id.";";
		...
		echo '<form action="tabela_wyjazdy_budowy_ukryj.php?id='.$id.$filters_path.'" method="post">	
		<table>

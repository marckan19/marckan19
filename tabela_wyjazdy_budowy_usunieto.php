...
if((isset($_SESSION['user_id']) && $_SESSION['user_type'] == 'a') || (isset($_COOKIE['ciastko_zalogowany']) && $_COOKIE['ciastko_zalogowany'] == 'a')){
	...
	if($row_header['header'] == 'n'){
		echo '<h2>Baustellen - Baustelle löschen</h2>';
	}else{
		echo '<h2>Wyjazdy - usuwanie budowy</h2>';
	}
	echo '</div><br /><br /><br /><br /><br /><br /><br /><br /><br />';
		
		if($row_header['header'] == 'n'){
			echo '<div id="success">Baustelle wurde gelöscht</div><br />';
		}else{
			echo '<div id="success">Budowa została usunięta.</div><br />';
		}
